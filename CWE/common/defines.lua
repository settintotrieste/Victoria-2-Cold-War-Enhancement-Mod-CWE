...
diplomacy = {
	...
	AT_WAR_TENSION_DECAY = -5, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	TENSION_ON_CB_DISCOVERED = 20,
	TENSION_ON_REVOLT = 50,
	TENSION_WHILE_CRISIS = -5.0,
	...
	RANK_1_TENSION_DECAY = -8, -- extra flashpoint tension decay for GPs
	RANK_2_TENSION_DECAY = -7,
	RANK_3_TENSION_DECAY = -6,
	RANK_4_TENSION_DECAY = -5,
	RANK_5_TENSION_DECAY = -4,
	RANK_6_TENSION_DECAY = -3,
	RANK_7_TENSION_DECAY = -2,
